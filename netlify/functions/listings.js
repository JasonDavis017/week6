...
exports.handler = async function(event) {
  ...
  // let returnValue = JSON.stringify(listingsFromCsv[0])
  ...
  // slight edit to code above to show the count and the listings over 99
  let listingsToReturn = {
    count: 0,
    listings:[]
  }
  ...
  return {
    ...
    //body: returnValue // a string of data
